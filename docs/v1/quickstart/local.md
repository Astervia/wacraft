...
> **v0.1.x (Legacy)** — [Switch to v0.2.x docs](../../quickstart/local.md)
...
- Consider using [a production Webhook Setup](../config/webhook-setup.md) when you switch to production.
